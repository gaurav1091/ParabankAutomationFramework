...
public final class ConfigManager {
	...
	public boolean isSeleniumGridExecution() {
		return isRemoteExecution()
				&& FrameworkConstants.REMOTE_PROVIDER_SELENIUM_GRID.equalsIgnoreCase(getRemoteProvider());
	}

	public boolean isBrowserStackExecution() {
		return isRemoteExecution()
				&& FrameworkConstants.REMOTE_PROVIDER_BROWSERSTACK.equalsIgnoreCase(getRemoteProvider());
	}
